  ...
  describe('#get(i)',  ()=> {
    ...
    test('should add(sum) all elements of the array if there are elements in the list', ()=> {
      ...
      describe('even()', ()=>{
        ...
        test('should return the element if it is even', ()=> {
          sl.add(1);
          sl.add(10);
          expect(sl.even(2)).toBe(10);
        });
        test('should return a Not Even Number exception if the number is not even', ()=> {

          const error = new TypeError('Not Even Number');
          sl.add(1);
          sl.add(10);
          expect(sl.even(1)).toThrow(error);
